<template>
  ...
  <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}">
    <a class="back" @click="$router.back()">
      <i class="iconfont iconicon_zuojiantou"></i>
    </a>
  </nav>
  <div class="shop-content" @click="toggleShopShow">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportShow">  <!--必须用v-if，三级表达式时要进行判断info是否存在-->
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[info.supports[0].type]">
          <span class="content-tag">
            <span class="mini-tag">{{info.supports[0].name}}</span>
          </span> <span class="activity-content ellipsis">{{info.supports[0].content}}</span>
        </div>
      </div>
      ...
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toggleShopShow">
            <span class="iconfont iconicon_closecopy"></span>
          </div>
        </div>
